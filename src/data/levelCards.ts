...
export const LEVEL_SITUATION_CARDS: GameCard[] = [
  ...
  {
    "id": "dc_s-034",
    "name": "Cheat Code Scam",
    "type": "decision",
    "tier": "common",
    "flavor": "'₹999 mein 1 lakh ka course.' Website looks legit. (If it looks too good, it usually is)",
    "options": [
      {
        "type": "save",
        "label": "Save",
        "description": "Research before buying. Refund policy?",
        "effect": {
          "type": "wealth_change",
          "value": 0,
          "target": "self"
      ...
      },
      {
        "type": "spend",
        "label": "Spend",
        "description": "-₹999 on fake course, zero content",
        "effect": {
          "type": "wealth_change",
          "value": -999,
          "target": "self"
  ...
  },
  {
    ...
    "type": "decision",
    "tier": "common",
    "flavor": "₹2,000 personal finance workshop. 'Boring lagega' dost bol raha. (The best investment is in your own brain)",
    "options": [
      {
        "type": "save",
        "label": "Save",
        "description": "+₹2,000 knowledge = ₹2L saved over life",
        "effect": {
          "type": "wealth_change",
          "value": 2000,
          "target": "self"
      ...
      },
      {
        "type": "invest",
        "label": "Invest",
        "description": "ROI: career, salary, decisions",
        "effect": {
          "type": "wealth_change",
          "value": 0,
          "target": "self"
      ...
      },
      {
        "type": "spend",
        "label": "Spend",
        "description": "-₹2,000 on weekend party instead",
        "effect": {
          "type": "wealth_change",
          "value": -2000,
          "target": "self"
