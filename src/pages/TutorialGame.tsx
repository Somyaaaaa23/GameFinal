...
export function TutorialGame() {
  ...
  const [gameState, setGameState] = useState<GameState>({
    ...
    players: [
      { id: myPlayerId, name: 'You', isBot: false, wealth: 50000, wealthFloor: 0, hand: [], activeDefenses: [], skippedTurns: 0, pendingGains: [], doubleInvestActive: false, investChoices: 0, emiDamageTaken: false },
      { id: botPlayerId, name: 'Rival CEO', isBot: true, wealth: 50000, wealthFloor: 0, hand: [], activeDefenses: [], skippedTurns: 0, pendingGains: [], doubleInvestActive: false, investChoices: 0, emiDamageTaken: false }
    ],
    deck: [],
    discardPile: [],
    wealthGoal: 1500000,
